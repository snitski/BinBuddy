        ...
        >
            <View style={styles.top}>
                ...
                :
                    ...
                    <Text style={{fontFamily: 'Lato_900Black', color:'#EDF1D6', fontSize: 18, alignSelf: 'center', margin: 2}}>
            ...
            <View style={styles.bottom}>
                <Text style={{fontFamily: 'Lato_900Black', color:'#EDF1D6', fontSize: 16, margin: 15}}>Tap anywhere to scan</Text>
            </View>
        </TouchableOpacity>
    );
}
